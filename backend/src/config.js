module.exports = {
    ...
    // CRM API
    crm: {
        // Sanitize URL to remove potential duplicate path if user set full endpoint in env
        url: (process.env.CRM_API_URL || 'https://apiimpulsa.impulsacrm.com/api/v2').replace(/\/oportunidades\/Crear\/?$/i, '').replace(/\/$/, ''),
